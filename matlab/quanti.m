function X_mdc = quanti(x)
    W32 = exp(-1j * 2 * pi/32 * (0:15)).';  % Twiddle factors
    W32 = quantize_fixed(W32, 7);
    %% === Stage 1 ===
    x1 = x(1:16);
    x2 = x(17:32);
    x1 = quantize_fixed(x1, 7);
    x2 = quantize_fixed(x2, 7);
    a1 = x1 + x2;
    b1 = quantize_fixed((x1 - x2), 7) .* W32;
    ...
    b2 = quantize_fixed(stage1_out([1:8 17:24]) - stage1_out([9:16 25:32]), 7) .* W32([1 3 5 7 9 11 13 15 1 3 5 7 9 11 13 15]);
    ...
    b3 = quantize_fixed(stage2_out([1:4 9:12 17:20 25:28]) - stage2_out([5:8 13:16 21:24 29:32]), 7) .* ...
    ...
    b4 = quantize_fixed(stage3_out(a4_idx1) - stage3_out(a4_idx2), 7) .* W32(repmat([1 9],1,8));
    stage4_out = zeros(32,1);
    a4 = quantize_fixed(a4, 7);
    b4 = quantize_fixed(b4, 7);
    ...
    a5 = quantize_fixed(a5, 7);
    b5 = quantize_fixed(b5, 7);
